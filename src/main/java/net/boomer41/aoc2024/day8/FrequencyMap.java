...
public class FrequencyMap {
    ...
    List<Antinode> calculateAntinodes(int limit, boolean includeAntennasAsAntinodes) {
    ...
    private void calculateAntinodesBetweenAntennas(List<Antinode> targetList, Vector2I a1, Vector2I a2, int limit, boolean includeAntennasAsAntinodes) {
    ...
    private void calculateSingleLine(List<Antinode> targetList, Vector2I start, Vector2I direction, int limit) {
